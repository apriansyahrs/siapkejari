                    ...
                    <div class="btn-list">
                        <div class="dropstart">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modal-report">Single</a></li>
                                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#generate-report">Generate</a></li>
                            </ul>
                        </div>
                            ...
                            <form action="{{ route('panel.payroll') }}" method="get">
                                <div class="row align-items-end">
                                    <div class="col-12 col-lg-3 mb-2 mb-lg-0">
                                        ...
                                        <input type="text" class="form-control" name="period_filter" value="{{ \Carbon\Carbon::parse($period)->format('m-Y') }}" autocomplete="off" readonly>
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ ($payrolls->currentpage()-1) * $payrolls->perpage() + $index + 1 }}</td>
                                        <td>
...
<div class="modal modal-blur modal-lg fade" id="modal-report" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" name="other-family-health-insurance-contribution" disabled>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" name="period" maxlength="7" autocomplete="off">
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="col-6">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" name="payment-date" maxlength="10" autocomplete="off">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
            </div>
...
<div class="modal modal-blur fade" id="generate-report" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label class="form-label">Periode</label>
                    <input type="text" class="form-control" name="period-generate" maxlength="7" autocomplete="off">
                    <div class="invalid-feedback"></div>
                </div>
                <div class="mb-3">
                    <label class="form-label">Tgl. Dibayarkan</label>
                    <input type="text" class="form-control" name="payment-date-generate" maxlength="10" autocomplete="off">
                    <div class="invalid-feedback"></div>
                </div>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    const otherFamilyHealthInsuranceContributionInput = document.querySelector('input[name="other-family-health-insurance-contribution"]');
    ...
    employeeInput.addEventListener('change', async (e) => {
        ...
        if (response.data) {
            employmentContractInput.value = response.data.employment_contract;
            salaryInput.value = response.data.salary;
            pph21AllowanceInput.value = response.data.allowance_pph_21;
            pph21DeductionInput.value = response.data.deduction_pph_21;
            healthInsuranceContributionInput.value = response.data.health_insurance_contribution;
            otherFamilyHealthInsuranceContributionInput.value = response.data.other_family_health_insurance_contribution;
            totalDeductionInput.value = response.data.total_deduction;
            netSalaryInput.value = response.data.net_salary;
            accountNumberInput.value = response.data.account_number;
        }
    });
    ...
    const showErrors = (errors) => {
        ...
        if (errors.health_insurance_contribution) {
            ...
            healthInsuranceContributionInput.nextElementSibling.textContent = errors.health_insurance_contribution[0];
        }
        if (errors.other_family_health_insurance_contribution) {
            otherFamilyHealthInsuranceContributionInput.classList.add('is-invalid');
            otherFamilyHealthInsuranceContributionInput.nextElementSibling.textContent = errors.other_family_health_insurance_contribution[0];
        }
