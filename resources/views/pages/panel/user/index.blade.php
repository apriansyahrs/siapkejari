                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-block">
                            <form action="{{ route('panel.user') }}" method="get">
                            ...
                            <table class="table table-vcenter card-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->id === auth('web')->user()->id)
                                            {{ $item->username }}
                                            @else
                                            <a href="{{ route('panel.user.show', $item->username) }}">{{ $item->username }}</a>
                                            @endif
                                        </td>
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->role }}</td>
...
<script>
    ...
    const disabledElement = () => {
        ...
        roleInput.setAttribute('disabled', '');
    ...
    const showErrors = (errors) => {
        ...
        if (errors.role) {
            ...
            roleInput.nextElementSibling.textContent = errors.role[0];
        }
        if (errors.is_active) {
    ...
    const clearErrors = () => {
        ...
        roleInput.nextElementSibling.textContent = '';
    ...
    const save = async () => {
        ...
        const response = await fetch(`${window.location.origin}/panel/user`, options);
